...
#                             sign_image = cv2.resize(sign_image, (150, 150))               
                sign_image=sign_image.reshape(1, 150, 150, 3)
                ...
                #=========================================================================
                prediction1 = {
                        '7aah'   :result[0][0],'ain'    :result[0][1],'aleff'  :result[0][2],'baa'     :result[0][3],'daad'   :result[0][4],'daal'   :result[0][5],'faa'    :result[0][6],'jeem'  :result[0][7], 
                        'ghain'  :result[0][8],'haa'    :result[0][9],'kaaf'   :result[0][10],'khaa'   :result[0][11],'laam'   :result[0][12],'meem'   :result[0][13],'nothing':result[0][14],'qaaf'   :result[0][15],
                        'raa'    :result[0][16],'saad'  :result[0][17],'seen'  :result[0][18],'sheen'  :result[0][19],'taa'    :result[0][20],'taahhh'   :result[0][21],'thaa'   :result[0][22],'waaw'   :result[0][23],
                        'yaaaa'  :result[0][24],'zaaaa' :result[0][25],'zain'  :result[0][26],'zalll'  :result[0][27]
                         }
                prediction2 = {
                        'ح'  :result[0][0] ,'ع' :result[0][1] ,'أ'   :result[0][2],'ب'     :result[0][3],'ض'  :result[0][4],'د'   :result[0][5],'ف'    :result[0][6],'ج'  :result[0][7], 
                        'غ'  :result[0][8] ,'ه'  :result[0][9] ,'ك'  :result[0][10],'خ'   :result[0][11],'ل'   :result[0][12],'م'   :result[0][13],'':result[0][14],'ق'   :result[0][15],
                        'ر'  :result[0][16],'ص':result[0][17] ,'س' :result[0][18],'ش'  :result[0][19],'ت'   :result[0][20],'ط'   :result[0][21],'ث'   :result[0][22],'و'   :result[0][23],
                        'ي'  :result[0][24],'ظ' :result[0][25] ,'ز' :result[0][26],'ذ'  :result[0][27]
                         }
...
#voice text
voiceTxt = customtkinter.CTkLabel(text="انا احمد",
                                 width=400,
                                 height=48,
